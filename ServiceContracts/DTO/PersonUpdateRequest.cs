...
namespace ServiceContracts.DTO
{
    ...
    public class PersonUpdateRequest
    {
        ...
        {
            return new Person {PersonID = PersonID, PersonName = PersonName, Email = Email, DateOfBirth = DateOfBirth, Gender = Gender.ToString(), Address = Address, ReceiveNewsLetters = ReceiveNewsLetters };
        }
    }
}
